...
public final class TerminalView extends View {
    ...
    public void updateSize() {
        ...
        // Defensive: the renderer is normally created by setTextSize(), but updateSize() may be
        // reached through other paths (e.g. attachSession() before the host set a text size).
        if (mRenderer == null) {
            mRenderer = new TerminalRenderer(
                (int) (12 * getResources().getDisplayMetrics().scaledDensity), Typeface.MONOSPACE);
        }
